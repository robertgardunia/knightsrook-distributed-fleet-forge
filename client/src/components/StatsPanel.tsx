...
export default function StatsPanel({ node }: { node: FleetNode }) {
  ...
  return (
    <div style={{ background: '#020c1b', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      <div style={{ background: '#020c1b', borderBottom: '1px solid #1e293b', flexShrink: 0, display: 'flex', alignItems: 'center' }}>
